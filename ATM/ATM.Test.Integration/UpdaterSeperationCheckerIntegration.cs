...
namespace ATM.Test.Integration
{
    ...
    class UpdaterSeperationCheckerIntegration
    {
        ...
        public void SeperationStopEvent_is_raised_on_event1()
        {
            ...
            Assert.That((Track)_raisedEvent.Track, Is.EqualTo(track2));
            Assert.That((Track)_raisedEvent.ConflictingTrack, Is.EqualTo(track1));
        }
        ...
        public void SeperationStopEvent_is_raised_on_event2()
        {
            ...
            Assert.That((Track)_raisedEvent.Track, Is.EqualTo(track1));
            Assert.That((Track)_raisedEvent.ConflictingTrack, Is.EqualTo(track2));
        }
    }
}